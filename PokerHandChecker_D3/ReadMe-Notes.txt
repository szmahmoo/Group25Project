Testing for program using PokerHandChecker_D3.cpp

1) poker.txt in this folder is NOT the 1000 case file for the project. 
   These are five cases from the actual assignment syllabus.

2) Known Bugs/Errors:
	- FIXED BUG: Full House Case (Hand 5: Player 2 wins instead of Player 1)
	  	     Screenshot of output for case is in folder
